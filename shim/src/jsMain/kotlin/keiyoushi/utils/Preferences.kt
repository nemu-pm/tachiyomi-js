/**
 * JS-compatible implementation of keiyoushi.utils.Preferences
 * Uses our Injekt shim instead of the real one.
 */
...
inline fun getPreferences(sourceId: Long): SharedPreferences =
    Injekt.get(Application::class).getSharedPreferences("source_$sourceId", 0x0000)
